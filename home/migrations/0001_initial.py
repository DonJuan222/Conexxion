# Generated by Django 4.1.3 on 2022-11-02 15:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pueblo', models.CharField(max_length=100, null=True, verbose_name='Nombre del pueblo')),
                ('direccion', models.CharField(max_length=100, null=True, verbose_name='Direccion')),
                ('vereda', models.CharField(max_length=100, null=True, verbose_name='Vereda')),
